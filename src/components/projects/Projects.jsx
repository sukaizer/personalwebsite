  ...
  return (
    <div className='site__projects'>
      ...
      <div className='site__projects-text'>
        <ProjectCart key="proj0" title="VRGeol" text={["vr app dedicated to learning fundamentals notions in geology"]} img={ unity } link="https://github.com/sukaizer/BirdScape"/>
